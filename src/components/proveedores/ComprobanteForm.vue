                        ...
                        <form @submit.prevent="save" class="space-y-6">
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button type="submit" class="btn-primary">
                                    {{ comprobante.id ? "Guardar" : "Agregar" }}
                                </button>
                            </div>
                        </form>
                    </div>
...
const comprobante = ref({ ...props.comprobante });

watch(
    () => props.comprobante,
    (newComprobante) => {
        comprobante.value = { ...newComprobante };
    },
    { immediate: true },
);
